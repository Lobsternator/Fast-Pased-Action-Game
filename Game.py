...
class Player():
    ...
    def Respawn(self):
        ...
        if len(Player.playerMortemList) != 0:
            if Contain(Player.playerMortemList, self)[0]:
                Player.playerList.append(self)

                index = Contain(Player.playerMortemList, self)[1]
    ...
    def Destroy(self):
        ...
        if len(Player.playerList) != 0:
            if Contain(Player.playerList, self)[0]:
                index = Contain(Player.playerList, self)[1]
